...
[English README](../README.md) · [Ouvrir TriView](https://relic-31.github.io/TriView/)

Complétez les lignes manquantes dans les vues de face, de gauche et de dessus. Choisissez un trait continu ou interrompu, puis une ligne, un arc ou un cercle. Une erreur permet de recommencer le même exercice ; une bonne réponse ouvre le suivant.
